...
CeruleanCave1F_TextPointers:
	def_text_pointers
	dba_const PickUpItemText, TEXT_CERULEANCAVE1F_ITEM1
	dba_const PickUpItemText, TEXT_CERULEANCAVE1F_ITEM2
	dba_const PickUpItemText, TEXT_CERULEANCAVE1F_ITEM3
