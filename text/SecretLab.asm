...
_SecretLabMewReactionText::
	text "MEW tremble dès"
	line "qu'il s'approche"
	cont "de cette petite"
	cont "machine."
	para "Le pauvre est"
	line "pétrifié."
	done
